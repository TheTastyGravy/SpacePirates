...
Shader "Universal Render Pipeline/Custom/Physically Based Example"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define _EMISSION   //unity refuses to define it so Ill do it myself
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                return half4(color, surfaceData.alpha);//(surfaceData.alpha - 0.5) * 2
            }
            ENDHLSL
        }
